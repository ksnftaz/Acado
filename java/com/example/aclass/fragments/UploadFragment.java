    ...
    private void sendNotification() {
        try {
            ...
            if (notificationId != null) {
                ...
                notificationData.put("type", "upload");
                notificationData.put("message", selectedFileName + " uploaded");
                notificationData.put("timestamp", System.currentTimeMillis());
                notificationData.put("uploaderEmail", mAuth.getCurrentUser().getEmail());

                notificationRef.child(notificationId).setValue(notificationData)
                        .addOnSuccessListener(unused -> Log.d(TAG, "Notification sent"))
